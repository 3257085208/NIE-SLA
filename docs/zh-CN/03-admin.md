...
“机器类型”是展示与分组用的用途标签，不改变探测协议或 Agent 行为。内置选项包括建站机、线路机、落地机、中转机、家宽机、解锁机、存储机、备份机、算力机、游戏机、邮件机、综合用途和其他；可以留空。

旧版本保存的“线路鸡”“落地鸡”“中转”“入口”“家宽”会继续原样显示，编辑时也不会被自动覆盖。新建节点建议使用规范的“机”字选项。
