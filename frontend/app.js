import { escapeAttr, escapeHtml } from './js/shared/html.js?v=20260919-update21';
import {
  billingCycleSuffix,
  isLifetimeBilling,
  normalizeBillingCycle,
} from './js/shared/billing.js?v=20260919-update21';
import {
  cssEscape,
  clampNumber,
  fmtBytes,
  ...
  pad,
  timeAgoSec,
} from './js/shared/format.js?v=20260919-update21';
import { trafficForTarget, trafficProgressHtml } from './js/shared/traffic.js?v=20260919-update21';
import { GROUP_BY_OPTIONS, groupByDimension, normalizeGroupByMode, displayGroupName as sharedDisplayGroupName } from './js/shared/grouping.js?v=20260919-update21';
import { canShowTemperature, hasGpuData, hasTemperatureData, isValidTemperature } from './js/shared/hardware.js?v=20260919-update21';
import { countryByCode } from './js/shared/target-catalogs.js?v=20260919-update21';
import {
  clampChartRange,
  countChartGaps,
  countMissedChecks,
  ...
  hexToRgba,
  trimEmptyPointEdges,
} from './js/shared/chart-data.js?v=20260919-update21';
import { bindNodeQualityModal, buildNqModalHtml, targetHasNodeQuality } from './js/shared/nodequality.js?v=20260919-update21';
import { DEFAULT_APPEARANCE, normalizeAppearance } from './js/shared/appearance.js?v=20260919-update21';
import { unlockState } from './js/shared/unlock.js?v=20260919-update21';
import { normalizeBackrouteEntries } from './js/shared/backroute.js?v=20260919-update21';
import { targetSlaPercentage } from './js/shared/sla.js?v=20260919-update21';
import { failedPingTargetsNear, latestPingByTarget, nextPingTargetSelection, normalizeLatencySample, pingSampleWindowSec } from './js/shared/ping.js?v=20260919-update21';
import { initializeFrontendTheme, publishThemeStatus } from './js/themes.js?v=20260919-update21';
import { readMigratedStorage, writeStorage } from './js/shared/storage.js?v=20260919-update21';
