...
assert.match(adminHtml, /admin\.css\?v=20260731-v1041/, 'admin CSS cache key must publish the current release');
assert.match(adminHtml, /js\/admin\.js\?v=20260731-v1041/, 'admin JS cache key must publish the credential-safe install flow');
...
assert.match(indexHtml, /app\.js\?v=20260731-v1041/, 'frontend cache key must publish the current release');
assert.match(indexHtml, /style\.css\?v=20260731-v1041/, 'frontend CSS cache key must publish the current release');
