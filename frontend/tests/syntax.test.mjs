...
assert.match(adminHtml, /admin\.css\?v=20260730-v1038/, 'admin CSS cache key must publish the current release');
assert.match(adminHtml, /js\/admin\.js\?v=20260730-v1038/, 'admin JS cache key must publish the current release');
...
assert.match(indexHtml, /app\.js\?v=20260730-v1038/, 'frontend cache key must publish the current release');
assert.match(indexHtml, /style\.css\?v=20260730-v1038/, 'frontend CSS cache key must publish the current release');
