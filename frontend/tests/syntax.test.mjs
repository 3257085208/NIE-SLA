...
assert.match(adminSource, /import \{ nqOptionsHtml, readNqOptions \} from "\.\/admin\/nq-options\.js\?v=20260802-v1067"/, 'admin must import the configurable NodeQuality option helpers');
...
assert.match(adminHtml, /href="\/admin\.css\?v=20260802-v1067"/, 'custom admin paths must load CSS from the site root');
...
assert.match(adminHtml, /src="\/js\/admin\.js\?v=20260802-v1067"/, 'custom admin paths must load the admin module from the site root');
...
assert.match(indexHtml, /style\.css\?v=20260802-v1067/, 'frontend CSS cache key must publish the current release');
