...
assert.match(adminHtml, /src="\/js\/admin\.js\?v=20260801-v1051"/, 'custom admin paths must load the admin module from the site root');
...
assert.match(adminSource, /install-command\.js\?v=20260801-v1051/, 'Agent and Latency install clipboard fixes must use the current cache key');
