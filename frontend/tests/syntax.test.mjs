...
assert.match(adminHtml, /href="\/admin\.css\?v=20260731-v1045"/, 'custom admin paths must load CSS from the site root');
...
assert.match(adminHtml, /src="\/js\/admin-bootstrap\.js\?v=20260731-v1045"/, 'admin login must install a startup failure guard');
assert.match(adminHtml, /src="\/js\/admin\.js\?v=20260731-v1045"/, 'custom admin paths must load the admin module from the site root');
...
assert.match(indexHtml, /app\.js\?v=20260731-v1045/, 'frontend cache key must publish the current release');
assert.match(indexHtml, /style\.css\?v=20260731-v1045/, 'frontend CSS cache key must publish the current release');
