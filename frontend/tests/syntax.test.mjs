...
assert.match(adminHtml, /href="\/admin\.css\?v=20260801-v1055"/, 'custom admin paths must load CSS from the site root');
...
assert.match(adminHtml, /src="\/js\/admin\.js\?v=20260801-v1055"/, 'custom admin paths must load the admin module from the site root');
...
assert.match(indexHtml, /style\.css\?v=20260801-v1055/, 'frontend CSS cache key must publish the current release');
