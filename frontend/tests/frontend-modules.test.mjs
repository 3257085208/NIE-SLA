...
assert.deepEqual(normalizeNqOptions({ hardware: 'v', ip: 'n', net: 'l', route: 'n', accelerator: 'eo' }), { hardware: 'v', ip: 'n', net: 'l', route: 'n', accelerator: 'eo' });
...
assert.match(nqOptionsMarkup, /value="eo" selected/);
