...
export function normalizeAppearance(input = {}, env = {}) {
  ...
  return {
    ...
    custom_head: optionalText(raw, 'custom_head', d.custom_head, 4000),
    custom_script: optionalText(raw, 'custom_script', d.custom_script, 4000),
    custom_bg: optionalUrl(raw, 'custom_bg', d.custom_bg),
    custom_bg_mobile: optionalUrl(raw, 'custom_bg_mobile', d.custom_bg_mobile),
