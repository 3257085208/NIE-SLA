export const DEFAULT_APPEARANCE = Object.freeze({
  ...
  show_card_sidebar: true,
  show_incidents: true,
  show_chart: true,
  show_card_latency: true,
...
export function normalizeAppearance(input = {}, env = {}) {
  ...
  return {
    ...
    brand_avatar_url: optionalUrl(raw, 'brand_avatar_url', d.brand_avatar_url),
    ...
    cards_search_placeholder: text(raw.cards_search_placeholder, d.cards_search_placeholder, 120),
    ...
    latency_title: text(raw.latency_title, d.latency_title, 40),
    latency_subtitle: text(raw.latency_subtitle, d.latency_subtitle, 80),
    ...
    show_region_filter: bool(raw, 'show_region_filter', d.show_region_filter),
    show_card_sidebar: bool(raw, 'show_card_sidebar', d.show_card_sidebar),
    show_incidents: bool(raw, 'show_incidents', d.show_incidents),
    show_chart: bool(raw, 'show_chart', d.show_chart),
    show_card_latency: bool(raw, 'show_card_latency', d.show_card_latency),
