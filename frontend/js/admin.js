import { agentInstallCommandFromPayload, agentRootlessInstallCommandFromPayload, latencyInstallCommandFromPayload, copyText } from "./install-command.js?v=20260925-visual2";
import { createAdminClient } from "./admin/api.js?v=20260925-visual2";
import { createOnboarding } from "./admin/onboarding.js?v=20260925-visual2";
import { latestAgentTaskMaps, shouldOpenNodeQualityReport } from "./admin/task-history.js?v=20260925-visual2";
import { nqOptionsHtml, readNqOptions } from "./admin/nq-options.js?v=20260925-visual2";
import { dailyFleetSlaSeries, targetSlaPercentage } from "./shared/sla.js?v=20260925-visual2";
import { bindNodeQualityModal, buildNqModalHtml, normalizeNqReportLink, renderUnlockServicesReportHtml, trimReportAdFooter } from "./shared/nodequality.js?v=20260925-visual2";
import {
  CURRENCIES,
  PROVIDERS,
} from "./shared/target-catalogs.js?v=20260925-visual2";
import {
  groupByDimension,
  groupByMenuHtml,
  lineTypeOptionsHtml,
...
} from "./shared/grouping.js?v=20260925-visual2";
import { readMigratedStorage, writeStorage } from "./shared/storage.js?v=20260925-visual2";
import { escapeAttr, escapeHtml } from "./shared/html.js?v=20260925-visual2";
import { fmtBytes } from "./shared/format.js?v=20260925-visual2";
