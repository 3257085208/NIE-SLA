...
assert.equal(info.current_version, '1.0.60');
...
const bundledManifest = {
  ...manifest,
  version: '1.0.60',
  source_ref: 'app-v1.0.60',
  title: 'NIE-SLA 1.0.60',
};
...
assert.equal(fallbackInfo.current_version, '1.0.60');
assert.equal(fallbackInfo.latest_version, '1.0.60');
