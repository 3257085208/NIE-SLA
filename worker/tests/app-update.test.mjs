...
assert.equal(info.current_version, '1.0.63');
...
const bundledManifest = {
  ...manifest,
  version: '1.0.63',
  source_ref: 'app-v1.0.63',
  title: 'NIE-SLA 1.0.63',
};
...
assert.equal(fallbackInfo.current_version, '1.0.63');
assert.equal(fallbackInfo.latest_version, '1.0.63');
