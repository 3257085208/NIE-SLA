...
assert.equal(info.current_version, '1.0.38');
...
const bundledManifest = {
  ...manifest,
  version: '1.0.38',
  source_ref: 'app-v1.0.38',
  title: 'NIE-SLA 1.0.38',
};
...
assert.equal(fallbackInfo.current_version, '1.0.38');
assert.equal(fallbackInfo.latest_version, '1.0.38');
