...
assert.equal(parseAppUpdateManifest(manifest).source_ref, 'app-v1.1.2');
...
assert.equal(info.current_version, '1.1.2');
assert.equal(info.latest_version, '1.1.2');
...
assert.equal(fallbackInfo.current_version, '1.1.2');
assert.equal(fallbackInfo.latest_version, '1.1.2');
...
assert.equal(staleInfo.latest_version, '1.1.2');
