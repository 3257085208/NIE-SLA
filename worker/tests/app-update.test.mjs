...
assert.equal(info.current_version, '1.0.49');
...
const bundledManifest = {
  ...manifest,
  version: '1.0.49',
  source_ref: 'app-v1.0.49',
  title: 'NIE-SLA 1.0.49',
};
...
assert.equal(fallbackInfo.current_version, '1.0.49');
assert.equal(fallbackInfo.latest_version, '1.0.49');
